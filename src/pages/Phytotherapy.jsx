            ...
            <div className="service-hero-banner">
                ...
                <div className="service-hero-banner-content">
                    ...
                    <p className="hero-desc">
                        ...
                        l'équilibre du corps et du mental, et mieux comprendre comment la nature soutient ton
                        organisme. Elle permet de soutenir les fonctions physiologiques, d'harmoniser les émotions
                        et d'accompagner le terrain en douceur, grâce aux ressources naturelles que le vivant met
                        à notre disposition.
                    </p>
            ...
            <div className="service-layout">
                ...
                <div className="service-content">
                    ...
                    <div className="service-content-section">
                        ...
                        <p>Dans mon accompagnement, j'utilise notamment :</p>
                        <ul>
                        ...
                        <p>
                            L'objectif n'est pas seulement de prendre une plante, mais de comprendre pourquoi elle
                            agit. Les plantes agissent en effet à plusieurs niveaux : elles peuvent soutenir les
                            fonctions physiologiques (digestion, sommeil, immunité, élimination…), mais aussi
                            accompagner les émotions et favoriser un retour à l'équilibre global.
                        </p>
                        <p>
                    ...
                    <div className="service-content-section">
                        <h2>Une approche globale du terrain</h2>
